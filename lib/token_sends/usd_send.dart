...
class UsdSend extends StatefulWidget {
  UsdSend({Key? key}) : super(key: key);

  @override
  State<UsdSend> createState() => _UsdSendState();
}

class _UsdSendState extends State<UsdSend> {
                                      ...
                                      return AlertDialog(
                                          ...
                                          content: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                    'Do you want to send ${amount.text} USD to ${recipient.text}?',
                                                                    ...
                                                                    content:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              'Your balance is insufficient USD.',
                                                                              textAlign: TextAlign.center,

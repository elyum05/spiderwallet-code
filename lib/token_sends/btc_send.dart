...
class BtcSend extends StatefulWidget {
  BtcSend({Key? key}) : super(key: key);

  @override
  State<BtcSend> createState() => _BtcSendState();
}

class _BtcSendState extends State<BtcSend> {
                                      ...
                                      return AlertDialog(
                                          ...
                                          content: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                    'Do you want to send ${amount.text} BTC to ${recipient.text}?',
                                                                    ...
                                                                    content:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              'Your balance is insufficient BTC.',
                                                                              textAlign: TextAlign.center,

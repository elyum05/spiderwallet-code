...
class UsdtSend extends StatefulWidget {
  UsdtSend({Key? key}) : super(key: key);

  @override
  State<UsdtSend> createState() => _UsdtSendState();
}

class _UsdtSendState extends State<UsdtSend> {
                                      ...
                                      return AlertDialog(
                                          ...
                                          content: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                    'Do you want to send ${amount.text} USDT to ${recipient.text}?',
                                                                    ...
                                                                    content:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                              'Your balance is insufficient USDT.',
                                                                              textAlign: TextAlign.center,

...
class _BitcoinState extends State<Bitcoin> {
  ...
  final btc_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (btc_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(btc_sum.text);
                                          double pay = btc_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${btc_sum.text} BTC?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

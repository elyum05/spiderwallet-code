...
class _VerifyState extends State<Verify> {
  ...
  final cred_sum = TextEditingController();
                    ...
                    : Expanded(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              double cred_price = 1.75;
                              return Column(
                                children: [
                                  Padding(
                                    padding: EdgeInsets.only(top: 35),
                                    child: Text('1 CRED = \$${cred_price}',
                                        style: TextStyle(
                                            color:
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (cred_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(cred_sum.text);
                                          double pay = cred_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${cred_sum.text} CRED?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

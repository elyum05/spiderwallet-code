...
class _CardanoState extends State<Cardano> {
  ...
  final ada_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (ada_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(ada_sum.text);
                                          double pay = ada_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${ada_sum.text} ADA?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

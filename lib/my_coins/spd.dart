...
class Spd extends StatefulWidget {
  Spd({Key? key}) : super(key: key);

  @override
  State<Spd> createState() => _SpdState();
}

class _SpdState extends State<Spd> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: [
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                          offset: Offset(2, -3),
                                          blurRadius: 15,
                                          color: Color.fromARGB(255, 4, 8, 255))
                                    ]),
                        ...
                        Center(
                          child: Text('${data['spd'].toString()} SPD',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 30,
                                  fontWeight: FontWeight.w500)),

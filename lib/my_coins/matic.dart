...
class Matic extends StatefulWidget {
  Matic({Key? key}) : super(key: key);

  @override
  State<Matic> createState() => _MaticState();
}

class _MaticState extends State<Matic> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text('${data['matic'].toString()} MATIC',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 30,
                                  fontWeight: FontWeight.w500)),

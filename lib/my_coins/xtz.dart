...
class Xtz extends StatefulWidget {
  Xtz({Key? key}) : super(key: key);

  @override
  State<Xtz> createState() => _XtzState();
}

class _XtzState extends State<Xtz> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: [
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                          ...
                                          blurRadius: 15,
                                          color:
                                              Color.fromRGBO(126, 224, 0, 0.85))
                                    ]),
                                child:
                                    Image.asset('assets/xtz.png', height: 107)),
                            width: 125,
                            height: 125,
                            alignment: Alignment.center,
                            decoration: BoxDecoration(
                        ...
                        Center(
                          child: Text('${data['xtz'].toString()} XTZ',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 30,
                                  fontWeight: FontWeight.w500)),

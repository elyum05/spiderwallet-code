...
class Algorand extends StatefulWidget {
  Algorand({Key? key}) : super(key: key);

  @override
  State<Algorand> createState() => _AlgorandState();
}

class _AlgorandState extends State<Algorand> {
  final Stream<QuerySnapshot> user = FirebaseFirestore.instance
      .collection('${FirebaseAuth.instance.currentUser!.email}')
      .snapshots();

  final algo_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        'Your balance: ${data['usdt'].toString()} USDT',
                                        style: TextStyle(
                                            color:
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (algo_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(algo_sum.text);
                                          double pay = algo_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${algo_sum.text} ALGO?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors
                                                                            ...
                                                                            content: Container(
                                                                              ...
                                                                              child: Column(
                                                                                children: [
                                                                                  ...
                                                                                  Text('Your balance is insufficient USDT.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w500)),
                                                                                  Padding(

...
class _PolygonState extends State<Polygon> {
  ...
  final matic_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  Padding(
                                    ...
                                    child: Text('1 MATIC = \$${matic_price}',
                                        style: TextStyle(
                                            color:
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (matic_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(matic_sum.text);
                                          double pay = matic_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${matic_sum.text} MATIC?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

...
class Ethereum extends StatefulWidget {
  Ethereum({Key? key}) : super(key: key);
...
class _EthereumState extends State<Ethereum> {
  ...
  final eth_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (eth_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(eth_sum.text);
                                          double pay = eth_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${eth_sum.text} ETH?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

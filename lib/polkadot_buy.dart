...
class Polkadot extends StatefulWidget {
  Polkadot({Key? key}) : super(key: key);
...
class _PolkadotState extends State<Polkadot> {
  ...
  final dot_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (dot_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(dot_sum.text);
                                          double pay = dot_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${dot_sum.text} DOT?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

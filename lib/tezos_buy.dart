...
class Tezos extends StatefulWidget {
  Tezos({Key? key}) : super(key: key);

  @override
  State<Tezos> createState() => _TezosState();
}

class _TezosState extends State<Tezos> {
  final Stream<QuerySnapshot> user = FirebaseFirestore.instance
      .collection('${FirebaseAuth.instance.currentUser!.email}')
      .snapshots();

  final xtz_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (xtz_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(xtz_sum.text);
                                          double pay = xtz_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${xtz_sum.text} XTZ?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors

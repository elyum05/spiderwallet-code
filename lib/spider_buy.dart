...
class _SpiderState extends State<Spider> {
  ...
  final spd_sum = TextEditingController();
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      onTap: () {
                                        if (spd_sum.text.isNotEmpty) {
                                          double amount =
                                              double.parse(spd_sum.text);
                                          double pay = spd_price * amount;
                                          showAnimatedDialog(
                                            context: context,
                                              ...
                                              return AlertDialog(
                                                  ...
                                                  content: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Text(
                                                            'Do you confirm to pay ${pay.toString()} USDT for ${spd_sum.text} SPD?',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: Colors
